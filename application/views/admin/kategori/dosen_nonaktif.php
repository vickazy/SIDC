<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-list"/></span> &nbsp <a href="<?php echo site_url('kategori/nonaktif');?>"><strong>Kategori Dosen Nonaktif</strong></a>
		</h4>
    </div>
	
	<!--bawah panel / tambah dan cari-->
	<div class="well well-sm">
			<a href="<?php echo site_url('kategori');?>" class="btn btn-success"><i class="glyphicon glyphicon-star"></i> Lihat Data Aktif</a>
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<tr>
				...
				<td width=150 align = "center">
						...
						<a href="<?php echo site_url('kategori/aktifkan/'.$row->id_kategori);?>"
							class='tooltipsku' 
							data-toggle='tooltip' 
							data-placement='top' 
