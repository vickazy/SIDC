<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-list"/></span> &nbsp <a href="<?php echo site_url('kategori/mahasiswa_nonaktif');?>"><strong>Kategori Mahasiswa Nonaktif</strong></a>
		</h4>
    </div>
	
	<!--bawah panel / tambah dan cari-->
	<div class="well well-sm">
			<a href="<?php echo site_url('kategori/kategori_mahasiswa');?>" class="btn btn-success"><i class="glyphicon glyphicon-star"></i> Lihat Data Aktif</a>
		<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('kategori/carinon');?>" method="post">
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<tr>
				...
				<td width=150 align = "center">
						...
						<a href="<?php echo site_url('kategori/aktifkanmhs/'.$row->id_kategori);?>"
							class='tooltipsku' 
							data-toggle='tooltip' 
							data-placement='top' 
