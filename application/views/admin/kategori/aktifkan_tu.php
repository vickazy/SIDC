<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-list"/></span> &nbsp <a href="<?php echo site_url('kategori/kategori_tu');?>"><strong>Kategori Tata Usaha Nonaktif</strong></a>
		...
		<form class="form-horizontal" action="<?php echo site_url('kategori/aktifkan_prosestu/'.$id);?>" method="post" enctype="multipart/form-data">
