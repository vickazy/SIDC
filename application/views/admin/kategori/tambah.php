<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			...
			<span class="glyphicon glyphicon-forward"/></span> <strong> Tambah Kategori Dosen</strong>
		</h4>
    </div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="card">
					...
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?php echo site_url('kategori/tambah_proses');?>" method="post">
