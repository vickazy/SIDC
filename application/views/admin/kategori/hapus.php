<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-list"/></span> &nbsp <a href="<?php echo site_url('kategori');?>"><strong>Kategori Aktif</strong></a>
	...
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo site_url('kategori/hapus_proses/'.$id);?>" method="post" enctype="multipart/form-data">
