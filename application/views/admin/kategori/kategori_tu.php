<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-list"/></span> &nbsp <a href="<?php echo site_url('kategori/kategori_tu');?>"><strong>Kategori Tata Usaha Aktif</strong></a>
		</h4>
    </div>
	
	<!--bawah panel / tambah dan cari-->
	<div class="well well-sm">
		<a href="<?php echo site_url('kategori/tambah_tu');?>" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah Kategori Tata Usaha</a>
		<a href="<?php echo site_url('kategori/tu_nonaktif');?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Lihat Kategori Tata Usaha Nonaktif</a>
	...
	<div class="panel-body">		
		...
		<div class="well well-sm">
			<a href="<?php echo site_url('kategori/index');?>" class="btn btn-primary"><i class="glyphicon glyphicon-list"></i> Lihat Kategori Dosen</a>
		...
		<table class="table table-hover table-responsive table-bordered">
			...
			<?php $no=0; foreach($kategori_tu as $row): $no++;?>
			<tr>
				...
				<td width=40 align = "center">
					...
					<a href="<?php echo site_url('kategori/hapustu/'.$row->id_kategori);?>" 
						...
						> <!--id_kategori_tu dibawa ke controller-->
