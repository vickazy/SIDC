<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-user"/></span> &nbsp <a href="<?php echo site_url('mahasiswa');?>"><strong>Detail Mahasiswa</strong></a>
	...
	<div class="card-body">
		<form class="form-horizontal" action="<?php echo site_url('mahasiswa/hapusgambarmhs/'.$idup).'/'.$id;?>" method="post" enctype="multipart/form-data">
			...
			<div class="col-sm-20">
				<div class="well well-sm">
					<div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-5">
							<a href="<?php echo site_url('mahasiswa/detail/'.$id);?>" class="btn btn-default"><i class="glyphicon glyphicon-backward"></i> Kembali</a>
						</div>
					</div>
				</div>
			</div>
