<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-user"/></span> &nbsp <a href="<?php echo site_url('dashboard/profil/'.$id);?>"><strong><?php echo $mahasiswa['nama_mahasiswa'];?></strong></a>
		...
		<div class="well well-lg">
			...
			<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('mahasiswa/editpass/'.$id);?>" method="post">
				<div class="form-group">
					...
					<input readonly required value="<?php echo $mahasiswa['username'];?>" type="text" class="form-control" size="12" maxlength="20" >
		...
		<form class="form-horizontal" action="<?php echo site_url('mahasiswa/edit_proses2/'.$id);?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="rt" id="tanggal" class="form-control" value="<?php echo $mahasiswa['rt'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">RW</label>
							<div class="col-sm-9">
								<input type="text" name="rw" id="tanggal" class="form-control" value="<?php echo $mahasiswa['rw'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Desa</label>
							<div class="col-sm-9">
								<input type="text" name="desa" id="tanggal" class="form-control" value="<?php echo $mahasiswa['desa'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Kecamatan</label>
							<div class="col-sm-9">
								<input type="text" name="kecamatan" id="tanggal" class="form-control" value="<?php echo $mahasiswa['kecamatan'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Kota</label>
							<div class="col-sm-9">
								<input type="text" name="kota" id="tanggal" class="form-control" value="<?php echo $mahasiswa['kota'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Kode Pos</label>
							<div class="col-sm-9">
								<input type="text" name="kode_pos" id="tanggal" class="form-control" value="<?php echo $mahasiswa['kode_pos'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Provinsi</label>
							<div class="col-sm-9">
								<input type="text" name="provinsi" id="tanggal" class="form-control" value="<?php echo $mahasiswa['provinsi'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Phone</label>
							<div class="col-sm-9">
								<input type="text" name="phone" id="tanggal" class="form-control" value="<?php echo $mahasiswa['phone'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Golongan Darah</label>
							<div class="col-sm-9">
								<input type="text" name="gol_darah" id="tanggal" class="form-control" value="<?php echo $mahasiswa['gol_darah'];?>">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="tanggal_lahir" class="form-control" value="<?php echo $mahasiswa['tanggal_lahir'];?>">
							</div>
						</div>
						<div class="form-group">
