<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-user"/></span> &nbsp <a href="<?php echo site_url('dashboard/profil/'.$id);?>"><strong><?php echo $tata_usaha['nama_tu'];?></strong></a>
		...
		<div class="well well-lg">
			&nbsp;
			&nbsp;
			<form class="navbar-form navbar-right" role="search" action="<?php echo site_url('tata_usaha/editpass/'.$id);?>" method="post">
				<div class="form-group">
					<label class="control-label"> Username</label>
					<input required readonly value="<?php echo $tata_usaha['username'];?>" type="text" name="username" class="form-control" size="12" maxlength="20" >
					<label class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Password</label>
					<input required value="<?php echo $tata_usaha['password'];?>" type="password" name="password" class="form-control" size="18" maxlength="20" >
	...
	<!--pesan error/sukses/dll-->	
		...
		<form class="form-horizontal" action="<?php echo site_url('tata_usaha/edit_proses2/'.$id);?>" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label class="col-sm-2 control-label">NIP / ID Tata Usaha</label>
				<div class="col-sm-9">
					<input required disabled value="<?php echo $tata_usaha['id_tu'];?>" type="text" name="id_tata_usaha" class="form-control" onkeypress="return isNumberKey(event)" size="12" maxlength="20" >
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Nama</label>
				<div class="col-sm-9">
					<input required value="<?php echo $tata_usaha['nama_tu'];?>" type="text" name="nama" maxlength=100 class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Tempat Lahir</label>
				<div class="col-sm-9">
					<input required value="<?php echo $tata_usaha['tmpt_lahir'];?>" type="text" name="tempat" maxlength=100 class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Tanggal Lahir</label>
				<div class="col-sm-9">
					<input required value="<?php echo $tata_usaha['tgl_lahir'];?>" type="date" name="tgl_lahir" id="tanggal" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select required name="jenis_kelamin" class="form-control">
						<?php $jenis=$tata_usaha['jenis_kelamin'];?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select required name="pendidikan" class="form-control">
						<?php $Pendidikan=$tata_usaha['pendidikan_akhir'];?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select required name="status_kepegawaian" class="form-control">
						<?php $status_kepegawaian=$tata_usaha['status_kepegawaian'];?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select required name="status_keanggotaan" class="form-control">
						<?php $status_keanggotaan=$tata_usaha['status_keanggotaan'];?>
						<option value="">Status Anda?</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea required value="<?php echo $tata_usaha['alamat'];?>" class="form-control" name="alamat" rows="3"><?php echo $tata_usaha['alamat'];?></textarea>
				</div>
			</div>
			<div class="col-sm-20">
