<div class="panel panel-info side-body">
	...
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="glyphicon glyphicon-th"/></span> &nbsp <a href="<?php echo site_url('dosen');?>"><strong>Dosen Nonaktif</strong></a>
		...
		<form class="form-horizontal" action="<?php echo site_url('tata_usaha/aktif_proses/'.$id);?>" method="post" enctype="multipart/form-data">
